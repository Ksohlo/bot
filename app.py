...
# Load datasets
try:
    lecturers_data = pd.read_csv(r'C:\Users\K_sohlo\Downloads\bot\dataset\lecturers.csv')
    coesa_data = pd.read_csv(r'C:\Users\K_sohlo\Downloads\bot\dataset\coesa.csv')
    students_data = pd.read_csv(r'C:\Users\K_sohlo\Downloads\bot\dataset\students.csv')
